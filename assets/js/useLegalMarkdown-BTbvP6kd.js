import{o as e,m as o,a as t,p as i,q as r}from"./index-D_sgZmgA.js";import{b as a}from"./query-vendor-Dd2uS8re.js";const n=String.raw`Terms of Service
...
If you notify us of accessibility needs, we may attempt to relay those requests to the relevant carrier, hotel, supplier, or partner, but we cannot guarantee any such requests will be received or honored. If you encounter an accessibility issue, contact support@trypackai.com.
...
Unauthorized access: You must immediately notify us at support@trypackai.com if you know or have any reason to suspect that your account has been compromised. You agree not to create any account if we have previously removed you or previously banned you from any of our Service, unless we provide written consent otherwise.
...
Notices of copyright infringement claims should be sent by mail to: DoneAI, Attn: Copyright Agent, 584 Castro St, Suite #4036, San Francisco, CA 94114; or by e-mail to support@trypackai.com.
...
Opt-Out. You have the right to opt-out and not be bound by the arbitration and waiver of class provisions set forth in these Terms by sending written notice of your decision to opt-out to support@trypackai.com or to DoneAI, 584 Castro St, Suite #4036, San Francisco, CA 94114. The notice must be sent to DoneAI within thirty (30) days of your registering to use the Service or agreeing to these Terms, otherwise you shall be bound to arbitrate disputes in accordance with these Terms, and the notice must specify your name and mailing address. If you opt-out of these arbitration provisions, DoneAI also will not be bound by them.
...
**Mailing Address:** DoneAI, 584 Castro St, Suite #4036, San Francisco, CA 94114
`,c=String.raw`# Do Not Sell or Share My Personal Information
...
4. **Contact us directly:** support@trypackai.com
...
1. **Email us**: support@trypackai.com
...
`,l={defaultLocale:"en",overrideEnvVar:"DONEAI_LEGAL_OVERRIDE",documents:[{id:"privacy-policy",locale:"en",title:"Privacy Policy",translationNamespace:"legal.privacyPolicy",publicPath:"/PrivacyPolicy.md",sourceFile:"public/PrivacyPolicy.md",fallbackExportName:"PRIVACY_POLICY_FALLBACK",lock:{mode:"hard",reviewed:!0,reviewedAt:"2026-04-09",reviewedSha256:"d683c782470d9fb2a0bb25e46ef7065603919e49f4c4e59298b481d13acf11bc"}},{id:"terms-of-service",locale:"en",title:"Terms of Service",translationNamespace:"legal.termsOfService",publicPath:"/TermsOfService.md",sourceFile:"public/TermsOfService.md",fallbackExportName:"TERMS_OF_SERVICE_FALLBACK",lock:{mode:"hard",reviewed:!0,reviewedAt:"2026-04-09",reviewedSha256:"f0d81327879cb7c29490cb7bc721a616b6f7acfcd48b59df1b8fcaecee2f770c"}}],auxiliaryFiles:[{id:"legal-fallbacks",sourceFile:"src/content/legalFallbacks.ts",lock:{mode:"hard",reviewed:!0,reviewedAt:"2026-04-09",reviewedSha256:"105c4728db2e8a6af88847835f86f1bc034bdd1abda0c6bd49fbf79da894492a"}},{id:"legal-ui-copy",sourceFile:"src/legal/legalUiCopy.json",lock:{mode:"hard",reviewed:!0,reviewedAt:"2026-04-09",reviewedSha256:"ebff6273cd9ff98212983290afb586f71f7ef07613dfe387c25c27178d2280fb"}},{id:"authorized-agent-process",sourceFile:"public/AuthorizedAgent.md",lock:{mode:"hard",reviewed:!0,reviewedAt:"2026-04-09",reviewedSha256:"a673e698389283f4d05677f9a509edebbf4c9d7b589d37d000cc7abe2bf0d78c"}},{id:"ccpa-request-page",sourceFile:"public/ccpa-request.html",lock:{mode:"hard",reviewed:!0,reviewedAt:"2026-04-09",reviewedSha256:"3072fb7d800bac3aedb51b5b7e26d56d183fdcee96a3586a8888b09e34dd529b"}}]},d=e({mode:r(["hard"]),reviewed:i(!0),reviewedAt:t().min(1),reviewedSha256:t().min(1)}),u=e({id:t().min(1),locale:t().min(2),title:t().min(1),translationNamespace:t().min(1),publicPath:t().startsWith("/"),sourceFile:t().min(1),fallbackExportName:r(["DO_NOT_SELL_FALLBACK","PRIVACY_POLICY_FALLBACK","TERMS_OF_SERVICE_FALLBACK"]),lock:d}),h=e({id:t().min(1),sourceFile:t().min(1),lock:d}),p=e({defaultLocale:t().min(2),overrideEnvVar:t().min(1),documents:o(u).min(1),auxiliaryFiles:o(h).default([])}).parse(l),m={DO_NOT_SELL_FALLBACK:c,PRIVACY_POLICY_FALLBACK:s,TERMS_OF_SERVICE_FALLBACK:n};function y(e,o=p.defaultLocale){const t=p.documents.find(t=>t.id===e&&t.locale===o)??p.documents.find(o=>o.id===e&&o.locale===p.defaultLocale);if(!t)throw new Error(`Missing legal document for id "${e}" and locale "${o}"`);return{...t,fallbackContent:m[t.fallbackExportName]}}function f(e){if(!e)return e;const o=e.replace(/\r\n/g,"\n"),t=o.match(/^\s*#\s+.*\n+/);return t?o.slice(t[0].length).trimStart():e}function g(e){return`pack:legal-markdown:2026-03-26:${e}`}async function v(e){await new Promise(o=>setTimeout(o,e))}function b(e){if("undefined"==typeof window)return null;try{return window.localStorage.getItem(g(e))}catch{return null}}function w({url:e,timeoutMs:o=8e3,fallbackContent:t=""}){const i=Boolean(t),r=a({queryKey:["legal-markdown",e,o],staleTime:3e5,gcTime:18e5,retry:!1,queryFn:async()=>{const r=new AbortController,a=await async function(e){if("undefined"==typeof window)return null;if(!("caches"in window))return b(e);try{const o=await caches.match(e);return o&&o.ok?await o.text():b(e)}catch{return b(e)}}(e);try{const t=await async function(e,o,t){const i=[0,100,250];let r=null;for(const n of i){if(t.aborted)throw new DOMException("Aborted","AbortError");n>0&&await v(n);const i=new AbortController,s=setTimeout(()=>i.abort(),o),c=()=>i.abort();t.addEventListener("abort",c,{once:!0});try{const o=await fetch(e,{signal:i.signal,cache:"no-store"});if(!o.ok)throw new Error(`HTTP ${o.status} ${o.statusText}`);return await o.text()}catch(a){r=a}finally{clearTimeout(s),t.removeEventListener("abort",c)}}throw r instanceof Error?r:new Error("Failed to load")}(e,o,r.signal);return function(e,o){if("undefined"!=typeof window&&o)try{window.localStorage.setItem(g(e),o)}catch{}}(e,t),{content:t,state:"loaded",isShowingCachedContent:!1}}catch{if(a)return{content:a,state:"loaded",isShowingCachedContent:!0};if(i)return{content:t,state:"loaded",isShowingCachedContent:!0};throw new Error(`Failed to load legal markdown for ${e}`)}finally{r.abort()}},placeholderData:e=>e||(i?{content:t,state:"loaded",isShowingCachedContent:!0}:void 0)});if(r.isError)return{content:t,state:"error",isShowingCachedContent:!1};const n=r.data;return n||{content:t,state:i?"loaded":"loading",isShowingCachedContent:i}}export{y as g,f as s,w as u};
