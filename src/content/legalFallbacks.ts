/**
 * @fileoverview Bundled legal markdown fallbacks generated from public/*.md.
 * These strings let legal pages render immediately during SSR/hydration and when
 * the network is unavailable, while the canonical raw markdown files remain in public/.
 */

export const TERMS_OF_SERVICE_FALLBACK = String.raw`Terms of Service
