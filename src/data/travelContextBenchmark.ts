...
export const neurosymbolicComparison = {
  ...
  headline: "Pack passes all 10 hardest cases; raw max-thinking agents did not complete a valid case.",
  summary:
  ...
  estimateNote: "Raw LLM failures score 0 when they exceed provider limits, exceed the case budget, time out, or return an invalid plan.",
  rows: [
    {
    ...
    },
    {
      ...
      cost: "Provider limit",
      costMultiple: "N/A",
      runtime: "0/1 measured before provider-limit stop",
      calls: "Same tools, no Pack symbolic state",
      note: "The measured xhigh case hit an OpenAI token-per-minute limit before returning a valid plan.",
    },
    {
      system: "Claude Opus 4.7 max-thinking raw agent",
      outcome: "Fail",
      cost: "$10 cap hit on 3 cases",
      costMultiple: "Up to 228x per failed capped case",
      runtime: "0/10 hardest cases",
      calls: "Same tools, no Pack symbolic state",
      note: "Failures were provider overloads, invalid plans, and case-budget overruns.",
    },
  ],
};
...
export const hardestTenShootoutRows = [
  {
    ...
    packCost: "$0.094",
    gptScore: "0.00",
    gptCost: "Provider limit",
    gptResult: "TPM limit before valid plan",
    opusScore: "0.00",
    opusCost: "Provider overload",
    opusResult: "Provider overload",
  },
  {
    number: "008",
    ...
    packCost: "$0.043",
    gptScore: "Not run",
    gptCost: "Stopped after provider limit",
    gptResult: "Not completed",
    opusScore: "0.00",
    opusCost: "Provider overload",
    opusResult: "Provider overload",
  },
  {
    ...
    gptResult: "Not completed",
    opusScore: "0.00",
    opusCost: "Invalid plan",
    opusResult: "Missing required plan fields",
  },
  {
    number: "029",
    ...
    opusScore: "0.00",
    opusCost: "$10+",
    opusResult: "Exceeded $10 case budget",
  },
  {
    number: "047",
    title: "Miami F1 trip.",
