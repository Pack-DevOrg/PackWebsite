...
export const neurosymbolicComparison = {
  ...
  estimateNote: "Costs show the full cost for each run. Pack includes extraction, planning, and search. Raw-agent costs include all model work through completion, timeout, or service limit. Readable off-schema answers received manual content credit; schema-valid output is shown separately.",
  rows: [
    {
      system: "Pack",
      outcome: "Fail",
    ...
    },
    {
      ...
      note: "All ten answers were off-schema, but the readable plans were manually scored for content.",
    },
  ],
};
