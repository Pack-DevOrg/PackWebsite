...
// Generated by `cd DoneAI && npm run live-activity:review:clean`.
// Rerun that command whenever native Live Activity Swift artifacts change.
const nativeReviewRoot =
  "/@fs/Users/noahmitsuhashi/Code/DoneAll/DoneAI/manual-live-activity-review";
...
const websiteReviewRoot =
  "/@fs/Users/noahmitsuhashi/Code/DoneAll/DoneAIWebsite/artifacts/live-activity-lab";
...
function renderWatchSurface(state: LiveActivityMock) {
  ...
  return (
    <WatchCard $accent={state.accent}>
      <WatchTopRow>
        <DoneLogo src={doneAiLogo} alt="DoneAI logo" $size={16} />
        <WatchTimerChip>
...
function renderTopRow(state: LiveActivityMock) {
  return (
    <TopRow>
      <DoneLogo src={doneAiLogo} alt="DoneAI logo" $size={20} />
      <TitleBlock>
        {state.phaseLabel ? (
  ...
  return (
    <CompactIslandShell data-capture-target="dynamic-island-compact-raw">
      <CompactIslandSegment $align="left">
        <DoneLogo src={doneAiLogo} alt="DoneAI logo" $size={14} />
